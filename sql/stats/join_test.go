...
func TestJoin(t *testing.T) {
	tests := []struct {
		...
		{
			left: []sql.HistogramBucket{
				&Bucket{RowCnt: 20, DistinctCnt: 11, BoundVal: sql.UntypedSqlRow{10}, McvVals: []sql.UntypedSqlRow{{1}, {2}}, McvsCnt: []uint64{5, 5}, BoundCnt: 1},
			},
			right: []sql.HistogramBucket{
				&Bucket{RowCnt: 10, DistinctCnt: 6, BoundVal: sql.UntypedSqlRow{10}, McvVals: []sql.UntypedSqlRow{{2}}, McvsCnt: []uint64{4}, BoundCnt: 1},
			},
			exp: []sql.HistogramBucket{
		...
		{
			left: []sql.HistogramBucket{
				&Bucket{RowCnt: 20, DistinctCnt: 10, BoundVal: sql.UntypedSqlRow{10}, McvVals: []sql.UntypedSqlRow{{1}, {2}}, McvsCnt: []uint64{5, 5}, BoundCnt: 1},
			},
			right: []sql.HistogramBucket{
				&Bucket{RowCnt: 10, DistinctCnt: 6, BoundVal: sql.UntypedSqlRow{10}, McvVals: []sql.UntypedSqlRow{{3}}, McvsCnt: []uint64{4}, BoundCnt: 1},
			},
			exp: []sql.HistogramBucket{
		...
		},
		{
			...
			right: []sql.HistogramBucket{
				&Bucket{RowCnt: 10, DistinctCnt: 10, BoundVal: sql.UntypedSqlRow{10}, McvVals: []sql.UntypedSqlRow{{3}}, McvsCnt: []uint64{4}, BoundCnt: 1},
			},
			exp: []sql.HistogramBucket{
				&Bucket{RowCnt: 20, DistinctCnt: 10, BoundVal: sql.UntypedSqlRow{10}, BoundCnt: 1},
			},
